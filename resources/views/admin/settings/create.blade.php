...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="chairman_image">{{ trans('cruds.setting.fields.chairman_image') }}</label>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('contact_text') ? 'is-invalid' : '' }}" name="contact_text" id="contact_text">{!! old('contact_text') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('vision_text') ? 'is-invalid' : '' }}" name="vision_text" id="vision_text">{!! old('vision_text') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('mission_text') ? 'is-invalid' : '' }}" name="mission_text" id="mission_text">{!! old('mission_text') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('why_us_text') ? 'is-invalid' : '' }}" name="why_us_text" id="why_us_text">{!! old('why_us_text') !!}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="signature_image">{{ trans('cruds.setting.fields.signature_image') }}</label>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('home_section_1') ? 'is-invalid' : '' }}" name="home_section_1" id="home_section_1">{!! old('home_section_1') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('home_section_2') ? 'is-invalid' : '' }}" name="home_section_2" id="home_section_2">{!! old('home_section_2') !!}</textarea>
