    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('service') ? 'is-invalid' : '' }}" type="text" name="service" id="service" value="{{ old('service', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('team') ? 'is-invalid' : '' }}" type="text" name="team" id="team" value="{{ old('team', '') }}" required>
                @if($errors->has('team'))
                    <div class="invalid-feedback">
                        {{ $errors->first('team') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quotation_text') ? 'is-invalid' : '' }}" type="text" name="quotation_text" id="quotation_text" value="{{ old('quotation_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('live_url') ? 'is-invalid' : '' }}" type="text" name="live_url" id="live_url" value="{{ old('live_url', '') }}">
