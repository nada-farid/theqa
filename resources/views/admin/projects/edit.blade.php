...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="service">{{ trans('cruds.project.fields.service') }}</label>
                <input class="form-control {{ $errors->has('service') ? 'is-invalid' : '' }}" type="text" name="service" id="service" value="{{ old('service', $project->service) }}" required>
                @if($errors->has('service'))
                    <div class="invalid-feedback">
                        {{ $errors->first('service') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.service_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="duration">{{ trans('cruds.project.fields.duration') }}</label>
                <input class="form-control {{ $errors->has('duration') ? 'is-invalid' : '' }}" type="text" name="duration" id="duration" value="{{ old('duration', $project->duration) }}" required>
                @if($errors->has('duration'))
                    <div class="invalid-feedback">
                        {{ $errors->first('duration') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.duration_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="team">{{ trans('cruds.project.fields.team') }}</label>
                <input class="form-control {{ $errors->has('team') ? 'is-invalid' : '' }}" type="text" name="team" id="team" value="{{ old('team', $project->team) }}" required>
                @if($errors->has('team'))
                    <div class="invalid-feedback">
                        {{ $errors->first('team') }}
                    </div>
            ...
            <div class="form-group">
                <label for="long_description">{{ trans('cruds.project.fields.long_description') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('long_description') ? 'is-invalid' : '' }}" name="long_description" id="long_description">{!! old('long_description', $project->long_description) !!}</textarea>
                @if($errors->has('long_description'))
                    <div class="invalid-feedback">
                        {{ $errors->first('long_description') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.long_description_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="quotation_text">{{ trans('cruds.project.fields.quotation_text') }}</label>
                <input class="form-control {{ $errors->has('quotation_text') ? 'is-invalid' : '' }}" type="text" name="quotation_text" id="quotation_text" value="{{ old('quotation_text', $project->quotation_text) }}">
                @if($errors->has('quotation_text'))
                    <div class="invalid-feedback">
                        {{ $errors->first('quotation_text') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.quotation_text_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="live_url">{{ trans('cruds.project.fields.live_url') }}</label>
                <input class="form-control {{ $errors->has('live_url') ? 'is-invalid' : '' }}" type="text" name="live_url" id="live_url" value="{{ old('live_url', $project->live_url) }}">
                @if($errors->has('live_url'))
                    <div class="invalid-feedback">
                        {{ $errors->first('live_url') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.live_url_helper') }}</span>
            </div>
            <div class="form-group">
